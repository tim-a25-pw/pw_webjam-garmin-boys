...
function create_cpt_oeuvre() {
	...
	$labels = array(
		...
		'name_admin_bar'        => __( 'Oeuvres', 'text_domain' ),
...
add_action( 'init', 'create_cpt_oeuvre', 0 );

// Register Custom Post Type
function create_cpt_membre() {
...
add_action( 'init', 'create_cpt_membre', 0 );
